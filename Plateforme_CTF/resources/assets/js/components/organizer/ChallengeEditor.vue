<template>
  <div>
    <div class="col-md-8">
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Editez le Challenge : {{ cha_name }}</h3>
        </div>
        <div class="box-body">
      ...
      <div>
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">Ajouter des questions</h3>
          </div>
          <div class="box-body">
            <form data-parsley-validate>
              <div class="form-group">
                <label>Question</label>
                <input class="form-control" placeholder="Ennoncé" v-model="question" required="required" data-parsley-trigger="change focusout" data-parsley-required-message="This is required" type="text">
              </div>
              <div class="form-group">
                <label>Points de question</label>
                <input class="form-control" placeholder="Points flag" v-model="question_points" required="required" data-parsley-trigger="change focusout" data-parsley-required-message="This is required" type="text">
              </div>
              <div class="form-group">
                <label>Réponses</label>
                <input class="form-control" v-for="answer in answers" v-model="answer.text" type="text" placeholder="flag">
              </div>
              <button type="button" v-on:click="addAnswerInput" class="btn btn-default btn-flat"><span class="fa fa-plus"></span>Ajouter plus de réponses</button>
            ...
            <draggable :list="qa_list" class="question-list" :move="checkMove">
              <div v-for="(qa, index) in qa_list" class="que-list-item">
                <div v-bind:data-qindex="qa.ref_guid" class="grabbable">
                  ...
                  <p>Réponses correctes possibles:</p>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title">Editez la question</h4>
                  </div>
                  <div class="modal-body">
                    ...
                    <button type="button" v-on:click="addTempAnswerInput" class="btn btn-default btn-flat"><span class="fa fa-plus"></span> Ajouter plus de réponses</button>
                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Fermer</button>
                    <button type="button" v-on:click="updateQuestion" class="btn btn-primary">Sauvegarder les modifications</button>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="col-md-4">
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Joindre des fichiers</h3>
        </div>
        <div class="box-body">
