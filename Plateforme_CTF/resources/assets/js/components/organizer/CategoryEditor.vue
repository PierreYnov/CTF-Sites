<template>
  <div>
    ...
    <div class="col-md-5">
      ...
      <div v-else>
        <p class="text-muted">Aucune catégorie n'a encore été ajoutée!</p>
      </div>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title">Mettre à jour la catégorie</h4>
            </div>
            ...
            <div class="modal-footer">
              ...
              <button type="button" v-on:click="updateCategory" class="btn btn-primary">Sauvegarder les modifications</button>
            </div>
          </div>
        </div>
      </div><!-- /.modal -->
    ...
    <div class="col-md-7" v-show='showChallengeEditor'>
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">Catégorie : {{category_name_up}}</h3>
        </div>
        <div class="box-body">
          <h5>Ajouter un challenge</h5>
          <form data-parsley-validate v-on:submit.prevent>
            <div class="input-group input-group-sm">
              ...
              <span class="input-group-btn">
                <button type="button" v-on:click="saveChallenge" class="btn btn-default btn-flat">Sauvegarder</button>
              </span>
            </div>
            ...
            <div class="modal fade" id="chlngModal" tabindex="-1" role="dialog">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">Mettre à jour le défi</h4>
                  </div>
                  <form data-parsley-validate v-on:submit.prevent>
                    <div class="modal-body">
                        <div class="input-group col-md-12">
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="button" v-on:click="updateChallenge" class="btn btn-primary">Sauvegarder les modifications</button>
                    </div>
                  </form>
                </div>
              </div>
          ...
          <div v-else>
            <p class="text-muted">Aucun challenge n'a encore été créé!</p>
          </div>
        </div>
      </div>
    </div>
