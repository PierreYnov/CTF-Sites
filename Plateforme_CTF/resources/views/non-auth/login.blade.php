    ...
    <div class="row">
      <div class="col-md-8 col-md-offset-2 login-box-body">
        <div class="col-md-6 col-md-offset-3">
          ...
          {!! Form::checkbox('remember', null, null) !!} Se souvenir
          </div>
          <button type="submit" class="btn btn-primary">
          S'identifier  <i class="glyphicon glyphicon-log-in"></i>
          </button>
          {!! Html::link('user/password/reset', 'Mot de passe oublié ?',array('class'=>'btn btn-link'))!!}
          <br>
          {!! Form::close() !!}
          <br>
        </div>
