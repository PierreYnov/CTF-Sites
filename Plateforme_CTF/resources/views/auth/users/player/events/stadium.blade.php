      ...
      <div class="col-md-6">
        ...
        <div class="box box-info">
          <div class="box-header">
            <h3 class="box-title">Vos statistiques</h3>
          </div>
          <div class="box-body">
            ...
            <div class="col-sm-4 col-xs-6">
              <div class="description-block border-right">
                ...
                <span class="description-text">Achèvement</span>
              </div>
            </div>
            <div class="col-sm-4 col-xs-12">
              <div class="description-block border-right">
                <h5 class="description-header">{{ $stats->incorrect_attempts }} </h5>
                <span class="description-text">Tentatives incorrectes</span>
              </div>
            </div>
          </div>
        </div>
        <div class="box box-info">
          ...
          <div class="box-footer text-center">
            <a href="{{ URL::to('/stadium/event/' . $event->ref_guid . '/leaderboard') }}" class="btn btn-sm btn-primary btn-flat">Voir le tableau complet</a>
          </div>
        </div>
      </div>
    </div>
