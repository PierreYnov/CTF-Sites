          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="/user/profile/edit">Editez les Informations</a></li>
                <li><a href="/user/settings/password">Paramètres de sécurité</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#"><i class="fa fa-trophy"></i><span>Competitions</span><i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="/event/new/register"><span>Ajouter une nouvelle</span></a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="/user/manager"><i class="fa fa-users"></i><span>Utilisateurs</span></a>
            </li>
          </ul>
        </section>
      </aside>
