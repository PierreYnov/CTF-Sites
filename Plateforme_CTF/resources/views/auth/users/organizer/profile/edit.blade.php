            ...
            <div class="box-body">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="form-group col-xs-6">
                    <div class="form-group{{ $errors->has('mobilenumber') }}">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group col-xs-12">
                    {{Form::button('Sauvegarder', array('type' => 'submit', 'class' => 'btn btn-primary has-spinner','data-loading-text' => "Saving...",'id' => 'loader1'))}}
                    {!! Form::close() !!}
                  </div>
                </div>
              </div>
